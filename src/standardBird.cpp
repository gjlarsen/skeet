...
{
     drawCircle(pointOfCurrentBird, 15);
}

/***************************************************************************
 * setOutside
 ***************************************************************************/
void StandardBird::setOutside()
{
